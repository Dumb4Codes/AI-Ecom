      ...
      >
        <CarouselContent className="-ml-4">
          {heroSlides.map((slide) => (
            ...
            >
              <article className="group relative h-[250px] overflow-hidden shadow-xs rounded-xl border
               border-border bg-card md:h-[260px]">
                ...
                <div className="relative z-10 flex h-full sm:max-w-[50%] flex-col justify-center gap-5 p-7 md:p-9">
                  ...
                  <h1 className="font-serif text-3xl font-semibold leading-[1.1] md:text-[2.1rem] text-black">
                    {slide.title}
                  </h1>
