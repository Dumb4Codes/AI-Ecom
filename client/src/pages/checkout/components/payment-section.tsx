...
const paymentOptions = [
  ...
  },
  {
    ...
    description: "Pay in cash when your order arrives — nothing charged now.",
    icon: Banknote,
  },
];
    ...
    <div className="flex flex-col gap-4">
      ...
      {paymentMethod === CheckoutPaymentMethod.CARD ? (
        <div className="rounded-xl border border-dashed border-border bg-muted/40 p-4">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ...
            order is only confirmed once payment succeeds.
          </p>
        </div>
      ) : null}
      ...
      {paymentMethod === CheckoutPaymentMethod.CASH_ON_DELIVERY ? (
        <div className="rounded-xl border border-dashed border-border bg-muted/40 p-4">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            No payment is collected now. You'll pay in cash when your order
            is delivered.
          </p>
        </div>
      ) : null}
